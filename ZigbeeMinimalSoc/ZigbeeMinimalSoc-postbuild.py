...
def S37():
    ...
    if ("iar" == "iar" or "iar" == ""):
        ...
        GCC_TOOLCHAIN_PATH = shortPath(r"file:/C:/Program%20Files%20(x86)/IAR%20Systems/Embedded%20Workbench%208.0/".replace(
            "file:", "").replace("%20", " "))
...
def EBL():
    ...
    EBL_COMMAND = START_FLAGS + shortPath(r"D:\SiliconLabs\SimplicityStudio\v4\developer\adapter_packs\commander\commander.exe").replace(
        " ", "\ ") + " ebl create " + EBL_FILE + " --app " + S37_BINARY + " --device EFR32MG1B232F256GM48 " + CONVERT_FLAGS
...
def GBL():
    ...
    GBL_COMMAND = START_FLAGS + shortPath(r"D:\SiliconLabs\SimplicityStudio\v4\developer\adapter_packs\commander\commander.exe").replace(
        " ", "\ ") + " gbl create " + GBL_FILE + " --app " + S37_BINARY + " --device EFR32MG1B232F256GM48"
...
if (not "efr32mg1b" or ("efr32mg1b" and not "efr32mg1b".startswith("EM3"))):
    S37()
